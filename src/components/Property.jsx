...
export default function Property() {
    ...
    return (
        <section >
            ...
            >
                <button onClick={closeModal} className="absolute top-10 md:top-4 right-5 text-white text-3xl z-50 text-[30px] border border-white p-[10px] rounded-full font-semibold over"><RxCross1 className="text-white text-3xl z-50 text-[30px] font-semibold  " /></button>
                <Swiper
                    modules={[Navigation, Pagination]}
                    navigation
                    pagination={{ clickable: true }}
